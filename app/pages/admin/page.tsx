    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-800 to-slate-600 overflow-auto">
      ...
      <main className="container mx-auto px-4 pb-16">
        <section className="mb-8">
          <h2 className="text-3xl font-bold text-white mb-4">Descargar Formatos Especiales</h2>
          <p className="text-gray-200 mb-4">Haz clic en los botones para descargar los formatos:</p>
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={() => handleDownload("/api/export/sabana", "Sabana_Caracas.xlsx")}
              className="bg-green-600 hover:bg-green-800 text-white px-6 py-3 rounded-lg transition-colors flex items-center justify-center"
            >
